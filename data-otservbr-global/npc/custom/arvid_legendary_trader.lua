local npcName = "Arvid, the legendary trader"
...
npcConfig.voices = {
	interval = 15000,
	chance = 20,
	{ text = "Bring me rare items, and I promise to reward you accordingly!" },
	{ text = "I'm interested in unique items, so I offer extraordinary rewards for them." },
	{ text = "The enemies you defeat become a part of you... That's what makes you stronger when you defeat them." },
}
...
npcConfig.shop = {
	...
	{ itemName = "all loot pouch container", clientId = 23721, sell = 1 },
}
...
local function greetCallback(npc, creature)
	...
	npcHandler:setMessage(MESSAGE_GREET, "Welcome, noble adventurer! How may I assist you? Just tell me {info} if you want to know my job.")
	return true
end
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "info") then
		npcHandler:say({
			"I am in search of the most diverse rare items, especially those that can only be obtained from powerful creatures... If you have something that might interest me, just tell me {trade}. I assure you that I always pay handsomely...",
		}, npc, creature, 3000)
...
npcHandler:setMessage(MESSAGE_FAREWELL, "I appreciate your time, noble adventurer. May the gods be with you!")

npcHandler:setMessage(MESSAGE_WALKAWAY, "I understand, you must be in a hurry...")
