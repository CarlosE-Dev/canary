...
local roulettePositions = positions.getRoulettePositions("1")
local actionId = 18571
...
function casinoRoulette.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	-- prevent to play when lever is pulled
	...
	-- prevent to play another roulette when another is in progress
	...
	-- prevent to play without tokens
	...
	-- prevent to play without room or capacity
