...
task_pt_br = {
	...
	returnButton = "Back",
	title = "Task Board",
	missionError = "Mission in progress or it has already been completed",
	uniqueMissionError = "You can have only one mission at a time.",
	missionErrorTwo = "You have completed the mission.",
	missionErrorTwoo = "\nHere are your rewards:",
	choiceText = "- Experience: ",
	messageAcceptedText = "You have accepted this mission!",
	...
	choiceCancelTaskError = "You cannot cancel this mission because it has already been completed or has not been started.",
	choiceBoardText = "Choose a mission and use the buttons below:",
	choiceRewardOnHold = "Redeem Reward",
	...
	messageCompleteTask = "You have finished this mission! \nType !task and claim your reward.",
}

taskConfiguration = {
	{ name = "Rotworm", color = 40, total = 2, type = "once", storage = 190006, storagecount = 190007, rewards = {
		{ 3043, 10 },
		{ "exp", 100000 },
	} },

	{ name = "Minotaur", color = 40, total = 5, type = "once", storage = 190000, storagecount = 190001, rewards = {
		{ 5804, 1 },
		{ "exp", 1000000 },
	} },

	{ name = "Dragon", color = 40, total = 1, type = "daily", storage = 190002, storagecount = 190003, rewards = {
		{ 3043, 100 },
		{ 5908, 1 },
		{ "exp", 1500000 },
	} },
...
function Player.addTaskKill(self, storage, count)
	...
	if kills + count >= data.total then
		if taskOptions.selectLanguage == 1 then
			...
			player:say("Task: " .. data.name .. " [Completed]!", TALKTYPE_MONSTER_SAY)
		else
